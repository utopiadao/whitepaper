      ...
      '/id/whitepaper/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '9.1 Kesalahpahaman 1: Ini adalah skema Ponzi atau kumpulan uang', link: '/id/whitepaper/chapter9/section1' },
            { text: '9.2 Kesalahpahaman 2: Pengembalian tinggi tidak berkelanjutan', link: '/id/whitepaper/chapter9/section2' },
            { text: '9.3 Kesalahpahaman 3: Kurangnya dukungan nilai nyata', link: '/id/whitepaper/chapter9/section3' },
            { text: '9.4 Kesalahpahaman 4: Kompleksitas teknis untuk menipu', link: '/id/whitepaper/chapter9/section4' },
            { text: '9.5 Kesalahpahaman 5: Risiko terlalu tinggi dan tidak terkendali', link: '/id/whitepaper/chapter9/section5' },
            { text: '9.6 Kesalahpahaman 6: Hanya permainan kentang panas', link: '/id/whitepaper/chapter9/section6' },
            { text: '9.7 Kesalahpahaman 7: Sistem mungkin dimanipulasi', link: '/id/whitepaper/chapter9/section7' },
