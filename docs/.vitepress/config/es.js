export const es = {
  ...
  themeConfig: {
    logo: '/logo/logo2.svg',
    nav: [
      { text: 'Selección de 36 Nodos Génesis', link: '/es/awakening/' },
      ...
      '/es/whitepaper/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '3.4 Proceso de Resonancia', link: '/es/whitepaper/chapter3/section4' }
          ]
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            { text: '9.1 Concepto Erróneo 1: Utopia es un Esquema Ponzi', link: '/es/whitepaper/chapter9/section1' },
            { text: '9.2 Concepto Erróneo 2: Los Altos Rendimientos son Irreales', link: '/es/whitepaper/chapter9/section2' },
            { text: '9.3 Concepto Erróneo 3: El Sistema es Demasiado Complejo para Usuarios Normales', link: '/es/whitepaper/chapter9/section3' },
            { text: '9.4 Concepto Erróneo 4: El Consenso Regional es un Esquema Piramidal', link: '/es/whitepaper/chapter9/section4' },
            { text: '9.5 Concepto Erróneo 5: El Reinicio Fénix es un Defecto del Diseño del Sistema', link: '/es/whitepaper/chapter9/section5' },
            { text: '9.6 Concepto Erróneo 6: Los Contratos Inteligentes Tienen Riesgos Técnicos', link: '/es/whitepaper/chapter9/section6' },
            { text: '9.7 Concepto Erróneo 7: Los Riesgos Regulatorios son Demasiado Altos', link: '/es/whitepaper/chapter9/section7' },
