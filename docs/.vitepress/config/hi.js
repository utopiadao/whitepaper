      ...
      '/hi/whitepaper/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '9.1 गलतफहमी 1: यह एक पॉन्जी स्कीम या मनी पूल है', link: '/hi/whitepaper/chapter9/section1' },
            { text: '9.2 गलतफहमी 2: उच्च रिटर्न टिकाऊ नहीं हैं', link: '/hi/whitepaper/chapter9/section2' },
            { text: '9.3 गलतफहमी 3: वास्तविक मूल्य समर्थन की कमी', link: '/hi/whitepaper/chapter9/section3' },
            { text: '9.4 गलतफहमी 4: धोखा देने के लिए तकनीकी जटिलता', link: '/hi/whitepaper/chapter9/section4' },
            { text: '9.5 गलतफहमी 5: जोखिम बहुत अधिक और अनियंत्रित', link: '/hi/whitepaper/chapter9/section5' },
            { text: '9.6 गलतफहमी 6: केवल एक हॉट पोटैटो गेम', link: '/hi/whitepaper/chapter9/section6' },
            { text: '9.7 गलतफहमी 7: सिस्टम में हेराफेरी हो सकती है', link: '/hi/whitepaper/chapter9/section7' },
