      ...
      '/ko/whitepaper/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '9.1 오해 1: 이것은 폰지 스킴이거나 자금 풀', link: '/ko/whitepaper/chapter9/section1' },
            { text: '9.2 오해 2: 높은 수익률은 지속 불가능', link: '/ko/whitepaper/chapter9/section2' },
            { text: '9.3 오해 3: 실제 가치 지원 부족', link: '/ko/whitepaper/chapter9/section3' },
            { text: '9.4 오해 4: 속이기 위한 기술적 복잡성', link: '/ko/whitepaper/chapter9/section4' },
            { text: '9.5 오해 5: 위험이 너무 높고 통제 불가능', link: '/ko/whitepaper/chapter9/section5' },
            { text: '9.6 오해 6: 단순한 뜨거운 감자 게임', link: '/ko/whitepaper/chapter9/section6' },
            { text: '9.7 오해 7: 시스템이 조작될 수 있음', link: '/ko/whitepaper/chapter9/section7' },
