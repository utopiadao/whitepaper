      ...
      '/ru/whitepaper/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '9.1 Заблуждение 1: Это схема Понци или денежный пул', link: '/ru/whitepaper/chapter9/section1' },
            { text: '9.2 Заблуждение 2: Высокие доходы неустойчивы', link: '/ru/whitepaper/chapter9/section2' },
            { text: '9.3 Заблуждение 3: Отсутствие поддержки реальной ценности', link: '/ru/whitepaper/chapter9/section3' },
            { text: '9.4 Заблуждение 4: Техническая сложность для обмана', link: '/ru/whitepaper/chapter9/section4' },
            { text: '9.5 Заблуждение 5: Риски слишком высоки и неконтролируемы', link: '/ru/whitepaper/chapter9/section5' },
            { text: '9.6 Заблуждение 6: Просто игра в горячую картошку', link: '/ru/whitepaper/chapter9/section6' },
            { text: '9.7 Заблуждение 7: Системой можно манипулировать', link: '/ru/whitepaper/chapter9/section7' },
