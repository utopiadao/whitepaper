      ...
      '/ar/whitepaper/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '9.1 سوء الفهم الأول: هذا مخطط بونزي أو صندوق أموال', link: '/ar/whitepaper/chapter9/section1' },
            { text: '9.2 سوء الفهم الثاني: العوائد العالية غير مستدامة', link: '/ar/whitepaper/chapter9/section2' },
            { text: '9.3 سوء الفهم الثالث: نقص الدعم بقيمة حقيقية', link: '/ar/whitepaper/chapter9/section3' },
            { text: '9.4 سوء الفهم الرابع: التعقيد التقني للخداع', link: '/ar/whitepaper/chapter9/section4' },
            { text: '9.5 سوء الفهم الخامس: المخاطر عالية جداً ولا يمكن السيطرة عليها', link: '/ar/whitepaper/chapter9/section5' },
            { text: '9.6 سوء الفهم السادس: مجرد لعبة تمرير الطبل والزهرة', link: '/ar/whitepaper/chapter9/section6' },
            { text: '9.7 سوء الفهم السابع: النظام قد يتم التلاعب به', link: '/ar/whitepaper/chapter9/section7' },
